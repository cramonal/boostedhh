...
xsecs["WminusH_Hto2B_Wto2Q_M-125"] = 0.5677 * BR_WQQ * BR_HBB
# 0.1068 (0.1887 from xsecdb, but missing Hdecay, 0.1887*BR_HBB=0.1096)
xsecs["WminusH_Hto2B_WtoLNu_M-125"] = 0.5677 * BR_WLNU * BR_HBB
# 0.349 (0.623 from xsecdb, but missing Hdecay, 0.623*BR_HBB=0.3619)
xsecs["WplusH_Hto2B_Wto2Q_M-125"] = 0.8889 * BR_WQQ * BR_HBB
# 0.1673 (0.3001 from xsecdb, but missing Hdecay, 0.3001*BR_HBB=0.1743)
xsecs["WplusH_Hto2B_WtoLNu_M-125"] = 0.8889 * BR_WLNU * BR_HBB
# 0.01635 (0.08545 from xsecdb, 0.08545*BR_HBB=0.049)
xsecs["ZH_Hto2B_Zto2L_M-125"] = 0.9439 * BR_ZLL * BR_HBB
# 0.3833 (0.5958 from xsecdb, 0.5958*BR_HBB=0.346)
xsecs["ZH_Hto2B_Zto2Q_M-125"] = 0.9439 * BR_ZQQ * BR_HBB
# 0.1486 (0.01351 from xsecdb, 0.01351*BR_HBB=0.00784)
xsecs["ZH_Hto2B_Zto2Nu_M-125"] = 0.9439 * BR_ZNUNU * BR_HBB
# 0.019 (0.5958 from xsecdb, 0.5958*BR_HCC=0.0172)
xsecs["ZH_Hto2C_Zto2Q_M-125"] = 0.9439 * BR_ZQQ * BR_HCC
...
xsecs["ggZH_Hto2B_Zto2Nu_M-125"] = 0.1360 * BR_ZNUNU * BR_HBB
...
hh = {
    ...
    "GluGlutoHHtoDECAY_kl-0p00_kt-1p00_c2-0p00": 75.76e-3,
    # 0.01167 (0.02964 from xsecdb, 0.02964*BR_HBB*BR_HBB=0.01005)
    "GluGlutoHHtoDECAY_kl-1p00_kt-1p00_c2-0p00": 34.13e-3,
    # 0.0338 (0.08664 from xsecdb, 0.08664*BR_HBB*BR_HBB=0.0293)
    "GluGlutoHHtoDECAY_kl-5p00_kt-1p00_c2-0p00": 99.65e-3,
    # 0.0051 (0.01252 from xsecdb, 0.01252*BR_HBB*BR_HBB=0.0042)
    "GluGlutoHHtoDECAY_kl-2p45_kt-1p00_c2-0p00": 14.916e-3,
    # from xsecdb
    "GluGlutoHHtoDECAY_kl-1p00_kt-1p00_c2-0p10": 0.01493,
    "GluGlutoHHtoDECAY_kl-1p00_kt-1p00_c2-0p35": 0.01052,
    "GluGlutoHHtoDECAY_kl-1p00_kt-1p00_c2-3p00": 2.802,
    "GluGlutoHHtoDECAY_kl-1p00_kt-1p00_c2-m2p00": 1.875,
}

# add for all decays
for key, value in hh.items():
    for decay, br in decays.items():
        tkey = key.replace("DECAY", decay)
        tkey_nounderscore = tkey.replace("-", "_")
        tvalue = value * br
        xsecs[tkey] = tvalue
        xsecs[f"{tkey}_LHEweights"] = tvalue
        xsecs[f"{tkey}_LHEweights_TuneCP5_13p6TeV_powheg-pythia8"] = tvalue

        tkey += "_TuneCP5_13p6TeV"
        xsecs[f"{tkey}"] = tvalue
        xsecs[f"{tkey}_powheg-pythia8"] = tvalue
...
vbfhh = {
    ...
    "VBFHHtoDECAY_CV-1_C2V-1_C3-2": 1.42e-3 * vbfhh_kfactor,
    # 0.0154350 * BR = 0.00528 (0.0156 from xsecdb)
    "VBFHHtoDECAY_CV-1_C2V-2_C3-1": 14.2e-3 * vbfhh_kfactor,
    # from Javier (interpolating): https://github.com/LPC-HH/HH4b/blob/main/src/HH4b/combine/binder/VBFXsec.ipynb
    # 0.1345 (0.3952 from xsecdb w/o BR, i.e. compare to 0.398705)
    "VBFHHtoDECAY_CV-1p74_C2V-1p37_C3-14p4": 0.398705,
    # 3.98e-6 (0.00001256 from xsecdbm i.e. compare to 0.0000118)
    "VBFHHtoDECAY_CV-m0p012_C2V-0p030_C3-10p2": 0.0000118,
    # 0.1236 (0.355 from xsecdb i.e. compare to 0.36648)
    "VBFHHtoDECAY_CV-m0p758_C2V-1p44_C3-m19p3": 0.36648,
    # 0.000367 (0.001113 from xsecdb i.e. compare to 0.001088)
    "VBFHHtoDECAY_CV-m0p962_C2V-0p959_C3-m1p43": 0.001088,
    # 0.001219 (0.003757 from xsecdb i..e compare to 0.003614)
    "VBFHHtoDECAY_CV-m1p21_C2V-1p94_C3-m0p94": 0.003614,
    # 0.00384 (0.01155 from xsecdb i.e. compare to 0.01139)
    "VBFHHtoDECAY_CV-m1p60_C2V-2p72_C3-m1p36": 0.01139,
    # 0.00558 (0.01663 from xsecdb i.e. compare to 0.01646)
    "VBFHHtoDECAY_CV-m1p83_C2V-3p57_C3-m3p39": 0.01646,
    # TODO: FIX OR CONFIRM THIS?
    # 0.2279 (0.672 from xsecdb i.e. compare to 0.056818 from interpolation (and 0.01917 when multiplied by BR)!!!!!!!!!)
    "VBFHHtoDECAY_CV-m2p12_C2V-3p87_C3-m5p96": 0.672,
}
